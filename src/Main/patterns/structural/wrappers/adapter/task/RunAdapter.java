package Main.patterns.structural.wrappers.adapter.task;
import Main.patterns.structural.wrappers.adapter.task.converter.xml.XMLConverter;
import Main.patterns.structural.wrappers.adapter.task.mapper.Mapper;
import Main.patterns.structural.wrappers.adapter.task.mapper.XMLAdapter;
import Main.patterns.structural.wrappers.adapter.task.mapper.json.JsonMapper;
